...
use App\Http\Requests\FuntionalQualityObjectivesRequest;
use App\Http\Requests\MonitoringSheetRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class FuntionalQualityObjectivesCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FuntionalQualityObjectivesCrudController extends CrudController
{
    ...
    public function store()
    {
        ...
        $request->request->set('category', 'fqo');
