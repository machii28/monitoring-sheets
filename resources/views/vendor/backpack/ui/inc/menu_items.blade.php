...
<x-backpack::menu-dropdown title="Monitoring Sheets" icon="la la-wpforms">
    <x-backpack::menu-item title="FQO" icon="la la-wpforms"></x-backpack::menu-item>
    <x-backpack::menu-item title="RR" icon="la la-wpforms"></x-backpack::menu-item>
    <x-backpack::menu-item title="PG" icon="la la-wpforms"></x-backpack::menu-item>
